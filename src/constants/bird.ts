...
export const DEFAULT_MAX_FORCE = 0.1; // how quickly birds can turn
export const DEFAULT_SEPARATION_RADIUS = 30; // personal space before avoiding
...
export function randomBoidCount() {
  return Math.floor(Math.random() * (MAX_BOID_COUNT - MIN_BOID_COUNT + 1)) + MIN_BOID_COUNT;
}
