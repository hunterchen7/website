...
export default function About() {
  return (
    <main class="text-center p-4 mx-auto my-auto justify-center flex flex-col font-mono text-violet-200 pb-20 h-screen max-w-[47rem] text-sm md:text-base gap-8">
      <Title>About Me</Title>
      <h1 class="text-2xl sm:text-4xl font-thin leading-tight mx-auto max-w-[14rem] md:max-w-none">
        about me..
      </h1>
      <p class="mx-auto leading-snug text-base">
